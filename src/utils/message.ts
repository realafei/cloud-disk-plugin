...
import MessageComponent from "@/components/Material/MaterialMessage.vue";
...
message.success = (msg: ContentType, options?: MessageTypeOptions) =>
  message({ ...options, type: "success", message: msg });
message.info = (msg: ContentType, options?: MessageTypeOptions) =>
  message({ ...options, type: "info", message: msg });
message.warning = (msg: ContentType, options?: MessageTypeOptions) =>
  message({ ...options, type: "warning", message: msg });
message.error = (msg: ContentType, options?: MessageTypeOptions) =>
  message({ ...options, type: "error", message: msg });
message.loading = (msg: ContentType, options?: MessageTypeOptions) =>
  message({ ...options, type: "loading", message: msg });
